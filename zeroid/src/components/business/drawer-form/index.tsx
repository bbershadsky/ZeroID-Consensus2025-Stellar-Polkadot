...
import { Drawer, DrawerHeader, ProductImageUpload } from "../..";
import { useImageUpload } from "../../../utils";
import { ICategory, IFile, ICandidate, Nullable } from "../../../interfaces";

type Props = {
  action: "create" | "edit";
};

export const BusinessDrawerForm = (props: Props) => {
